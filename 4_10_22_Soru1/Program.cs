   ...
   */
    internal class Program
    {
        ...
        //{
            ...
            //    int rastgele1 = random.Next(1,100);
            //    int rastgele2 = random.Next(1,100);


            //    Console.WriteLine(rastgele1 + " Birinci rastgele  " + rastgele2 + " İkinci rastgele  ");
            //    Console.WriteLine("Bu sayıların toplamı kaçtır ?");

            //    int sonuc = Convert.ToInt32(Console.ReadLine());

            //    if(rastgele1+rastgele2 == sonuc)
            //    {
            ...
            //    else
            //    {
            //        Console.WriteLine("Cevabınız yanlış" + " Cevap: " + (rastgele1+rastgele2));
            //        sayacYanlış++;
            //    }
            //    Console.WriteLine("Tekrar oynamak istiyor musunuz? (E/e) basın ! " );
            ...
            //    }
            //    Console.WriteLine("Puan: {0}\nDoğru Cevap: {1}\nYanlış Cevap: {2}", puan, sayacDogru, sayacYanlış);
